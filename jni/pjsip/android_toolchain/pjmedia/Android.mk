...
LOCAL_C_INCLUDES := $(LOCAL_PATH)/../pjlib/include $(LOCAL_PATH)/../pjlib-util/include \
	...
	$(LOCAL_PATH)/../third_party $(LOCAL_PATH)/../../../openh264/codec/api/ $(LOCAL_PATH)/../../../libyuv/include
...
LOCAL_SRC_FILES := $(PJLIB_SRC_DIR)/alaw_ulaw.c $(PJLIB_SRC_DIR)/alaw_ulaw_table.c \
	...
	$(PJLIB_SRC_DIR)/converter.c $(PJLIB_SRC_DIR)/converter_libyuv.c $(PJLIB_SRC_DIR)/event.c \
	...
	$(PJMEDIADEV_VIDEO_SRC_DIR)/opengl_dev.c $(PJMEDIADEV_VIDEO_SRC_DIR)/android_opengl.c $(PJMEDIADEV_VIDEO_SRC_DIR)/android_dev.c \
	$(PJMEDIADEV_VIDEO_SRC_DIR)/util.c \
	$(PJMEDIACODEC_SRC_DIR)/amr_sdp_match.c $(PJMEDIACODEC_SRC_DIR)/openh264.cpp $(PJMEDIACODEC_SRC_DIR)/h264_packetizer.c \
...
PJ_ANDROID_SRC_DIR := ../../sources/pjmedia/src

LOCAL_C_INCLUDES += $(LOCAL_PATH)/../../sources/pjmedia/include/pjmedia-audiodev \
	$(LOCAL_PATH)/../../../swig-glue
	
LOCAL_SRC_FILES += $(PJ_ANDROID_SRC_DIR)/pjmedia-audiodev/android_jni_dev.c

LOCAL_SHARED_LIBRARIES := openh libyuv
